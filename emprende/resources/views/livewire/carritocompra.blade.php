  ...
  <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      <div class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
        ...
        <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between sm:items-center">
          <div>
            ...
            <p class="mt-1 text-xs text-gray-700">${{$item->producto->precio}}</p>
          </div>
          <div class="mt-4 flex flex-col items-center sm:space-y-6 sm:mt-0 sm:flex sm:flex-row sm:items-center sm:space-x-6">
            ...
            <div class="flex items-center space-x-4 mt-2 sm:mt-0">
              <p class="text-sm">${{$item->producto->precio * $item->cantidad}}</p>
    ...
    <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
      ...
      <div class="flex justify-between">
        ...
        <p class="text-gray-700">${{ $this->envio }}</p>
      </div>
      <hr class="my-4" />
      <div class="flex justify-between">
      ...
      <button class="mt-6 w-full rounded-md bg-green-500 py-1.5 font-medium text-green-50 hover:bg-blue-600">Finalizar Compra</button>
    </div>
  </div>
</div>
