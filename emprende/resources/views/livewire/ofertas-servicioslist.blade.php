<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6 md-6 mt-3 d-flex justify-content-center">
            <div class="card mb-3" style="max-width: 250px; max-height: 350px; border-color: transparent;">
                    ...
                    <div class="col-12">
                        <div class="card-body">
                            ...
                            <p class="px-2" style=" margin-bottom: 0;">
                                <span class="fw-bold text-start " style="font-size: 15px; margin-bottom: 0;">Paquete: </span>{{ $ofertaVista->descripcion }}
                            </p>
