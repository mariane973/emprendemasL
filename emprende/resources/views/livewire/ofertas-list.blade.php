<div class="container">
    ...
    <div class="container mb-5 d-flex justify-content-center align-items-center">
        <h5 class="col-lg-8 col-sm-5 fw-semibold" style="color: green;">Ofertas - Productos</h3></h5>
        ...
        <div class="col-lg-3 col-sm-6 md-6 mt-3 d-flex justify-content-center">
            <div class="card mb-3" style="max-width: 280px; max-height: 390px; border-color: transparent;">
