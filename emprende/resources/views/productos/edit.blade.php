...
<form action="/productos/{{$productEditar->id}}" method="POST" class="form-editar" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" value="{{$productEditar->precio}}" name="precioEdit">
    </div>
    <div class="mb-3">
        <label for="stockProducto" class="form-label">Stock</label>
        <input type="number" class="form-control" value="{{$productEditar->stock}}" name="stockEdit">
    </div>
    <div class="mb-3">
